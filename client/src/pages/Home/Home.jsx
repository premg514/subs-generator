...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (subtitleData.startsWith('```srt\n')) {
      subtitleData = subtitleData.replace('```srt\n', '').replace('\n```', '');
    }
    ...
    <div className="subtitle-container">
      <div className="subtitle-card">
        <div className="card-header">
          ...
          <p className="card-subtitle">Upload a video file to automatically generate subtitles</p>
        </div>
              ...
              >
                ...
                <div>
                  <svg className="upload-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" className="upload-icon-inner"></path>
                    <polyline points="17 8 12 3 7 8" className="upload-icon-inner"></polyline>
                    <line x1="12" y1="3" x2="12" y2="15" className="upload-icon-inner"></line>
                  </svg>
                  ...
                  {error && (
                    <div style={{ color: 'var(--error)', marginTop: '0.75rem', fontSize: '0.875rem' }}>
                      {error}
                    </div>
                  )}
                </div>
